      ...
      <>
        <Card title="Edit task">
          ...
          <Row>
            ...
            <Column>
              <Form.Textarea value={this.task.description} 
              onChange={(event) => {this.task.description = event.currentTarget.value}} rows={10} />
            </Column>
          </Row>
          <Row>
            <Column width={2}>Done:</Column>
        ...
        <Row>
          <Column>
            <Button.Success onClick={() => {
                taskService
                  .update(this.task)  // <-- Kaller oppdateringsmetoden
      ...
      <>
        <Card title="New task">
          ...
          <Row>
            ...
            <Column>
              <Form.Textarea value={this.description} 
